    ...
    return (
        <div className='flex flex-col space-y-2 items-center'>
            ...
            <a href={url} target="_blank"
                ...
                <div className='flex justify-center items-center h-full w-full bg-gradient-to-t from-black/30 to-transparent
    ...
    return (
        <div>
            <div className='flex space-x-10'>
                <Card title='LinkedIn' value='/heducapi' icon={Linkedin} color='bg-[#0e76a8]' url='https://www.linkedin.com/in/heducapi/' />
