...
import fruitOS from './images/fruitOS.png';
import caribeBrew from './images/caribeBrew.jpg';
import liquidEmails from './images/liquidEmails.jpg';
import projectFlow from './images/projectFlow.png';

const projectsList = [
    {
        name: 'Caribe Brew',
        description: 'A fully branded Shopify store showcasing products and collections with a polished, user-friendly shopping experience..',
        tags: ['Shopify', 'Web', 'Password: rtieyu'],
        img: caribeBrew,
        url: 'https://caribe-brew.myshopify.com',
    },
    {
        name: 'Liquid Emails',
        description: "Demo of transactional email templates built with Liquid, used in Shopify stores.",
        tags: ['Liquid', 'Shopify'],
        img: liquidEmails,
        url: 'https://github.com/HenryCaicedo/liquid-emails',
    },
    {
        name: 'FruitOS',
    ...
    {
        name: 'ProjectFlow',
        description: "Web application focused on managing global projects, designed to prioritize availability and a consistent user experience.",
        tags: ['Next.js', 'Tailwind', 'Web'],
        img: projectFlow,
        url: 'https://github.com/HenryCaicedo/projectflow',
    },
    {
